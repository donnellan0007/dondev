...
class __TwigTemplate_419c7bd0105d886f5278703ff4cc5261143cde7e094ffd5a3a7631049c5ff578 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/filter/filter-tips.html.twig", "C:\\wamp64\\www\\dondev\\core\\themes\\olivero\\templates\\filter\\filter-tips.html.twig");
    }
